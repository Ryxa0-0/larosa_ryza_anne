...
<body class="min-h-screen bg-gradient-to-br from-pink-100 via-blue-100 to-pink-200 p-8">
    ...
    <div class="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm shadow-lg rounded-2xl p-8">
        ...
        <div class="flex gap-3">
            ...
            <a href="<?= site_url('students/delete_all') ?>"
                    ...
                    <?php if (!empty($students)): ?>
                        <?php foreach ($students as $student): ?>
                            <tr class="hover:bg-pink-50/50">
                                <td class="py-2 px-4 border-b border-blue-200"><?= html_escape($student['id']) ?></td>
                                <td class="py-2 px-4 border-b border-blue-200"><?= html_escape($student['last_name']) ?></td>
                                <td class="py-2 px-4 border-b border-blue-200"><?= html_escape($student['first_name']) ?></td>
                                <td class="py-2 px-4 border-b border-blue-200"><?= html_escape($student['email']) ?></td>
